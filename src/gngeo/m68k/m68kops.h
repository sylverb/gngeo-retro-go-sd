...
/* Build the opcode handler jump table (and/or cycle counts).
 * fill_jt: 0 = cycles only (JT already loaded from flash), 1 = both. */
static void m68ki_build_opcode_table(int fill_jt)
{
...
#define NEO_WDOG() wdog_refresh()
#else
#define NEO_WDOG() ((void)0)
#endif
