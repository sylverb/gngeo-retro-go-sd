...
/* Neo Geo core: do not import Gwenesis ROM_DATA symbols (clash with rom_manager.h). */
#if 0
#ifdef TARGET_GNW
...
#endif
#endif /* Neo Geo: disabled Gwenesis FETCH*RAM / ROM_DATA */
...
/* CPU cores — storage via dtc_calloc in cpu_68k_init (device DTCM / host heap). */
extern m68ki_cpu_core *m68k_core;
#define m68k (*m68k_core)
